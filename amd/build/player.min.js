...
define([], function() {
    ...
    function mount(wrapperEl, payload) {
        ...
        return loadDeps.then(function() {
            ...
            var startTime = parseFloat(payload.current_position);
            if (startTime && startTime > 0) {
                el.setAttribute('start-time', String(startTime));
                // Fallback: seek directly once metadata is ready, in case the
                // player build ignores start-time (which left it at 0).
                var resumeSeek = function() {
                    try {
