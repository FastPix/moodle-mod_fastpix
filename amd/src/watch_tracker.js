...
export const init = (player, config) => {
     ...
     *
     * @param {Object} response The record_view_progress web-service response.
     * @returns {void}
     */
     ...
     *
     * @param {Object} player The FastPix player element driving the tracker.
     * @returns {void}
     */
